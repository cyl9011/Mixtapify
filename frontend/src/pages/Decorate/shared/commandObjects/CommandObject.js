...
export default class CommandObject {
  constructor(
    ...
    this.targetObject = selectedObj; // object this command affected
    this.newValue = newValue; // new value used by the command
    this.oldValue = oldValue; // previous (old) value for the object
  }
